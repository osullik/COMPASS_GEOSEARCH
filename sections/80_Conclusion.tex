...
We present COMPASS, a collection of data structures and algorithms that frame geospatial search as a human-centric rather than a map-centric activity. 
%
The salient limitation of COMPASS is that it only handles point data for representing locations and querying.
...
Extending COMPASS to represent polygons and lines in the concept map abstraction is the most pressing aspect for future work, as it will likely immediately impact the human experience.
...
COMPASS takes an approach that mimics how humans perceive and remember the world around them. 
...
Abstracting away distance and global position to create \textit{concept maps} enables us to apply searching approaches that aggressively prune the search space with set operations and recursive grid searching. 
...
Our Cardinality-Invariant search achieves perfect recall on spatial datasets with power-law distributions of objects and object classes for a modest computational cost on queries of realistic sizes.
