...
The \emph{COMPASS} suite of data structures and algorithms addresses the complexity issues in several ways. First, we prune the search space by using the set-membership ideas to only conduct a spatial search on locations that can possible match those queries. 
