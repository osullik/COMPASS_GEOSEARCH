...
The core of \emph{GESTALT}'s geospatial search capability resides in the \emph{Concept Mapping} component.
...
\subsection{Concept Map Creation} \label{appendix:conceptcreation}
\begin{algorithm}[H]
    ...
    \begin{algorithmic}
        ...
        \Procedure{createConceptMap}{$T$}
            \State{LonList, LatList $\leftarrow$ []} \Comment{Lists}
